...
public class IntensiveCareDoctor extends Doctor implements IntensiveCareStaffMember, Serializable {
	...
	public IntensiveCareDoctor(int id, String firstName, String lastName, Date birthDate, String address,
							   String phoneNumber, String email, String gender, Date workStartDate, double salary,
							   int licenseNumber, boolean isFinishInternship, String username, String password) {
		super(id, firstName, lastName, birthDate, address, phoneNumber, email, gender, workStartDate, salary,
				licenseNumber, isFinishInternship, Specialization.IntensiveCare, username, password);
	...
	public IntensiveCareDoctor(int id, String firstName, String lastName, Date birthDate, String address, String phoneNumber,
